...
const DISTANCIA_HUIDA: float = 1200.0
...
func _analizar_campo() -> String:
	...
	# Pocos enemigos presionando: mandar kamikaze rápido
	...
	# Mantener composición equilibrada
...
func _on_invocado_destruido(_pos: Vector2, _recompensa: int) -> void:
	pass  # AscensionManager lleva el contador global
